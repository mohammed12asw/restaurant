                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/h-logo.png" align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section"><a href="{{url('/reservation')}}">Reservation</a></li> 

                            <!-- <li class=""><a rel="sponsored" href="https://templatemo.com" target="_blank">External URL</a></li> -->
                            <li class="scroll-to-section"><a href="{{url('/search')}}">Search</a></li> 
                                ...
                                Show Cart [{{ $count }}]
                                @else
                                <li class="scroll-to-section"><a href="{{ url('/showcart') }}">
